...
def  main():
  ...
  installer = "\installer\MasterVolumeAutoGain Installer.exe"
   
  if demo:
    installer = "\installer\MasterVolumeAutoGain Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\MasterVolumeAutoGain manual.pdf" 
  ]
  ...
  ZIPNAME = "MasterVolumeAutoGain-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "MasterVolumeAutoGain-v" + FULLVERSIONSTR + "-win-demo.zip"
