...
def main():
  ...
  plistpath = scriptpath + "/resources/MasterVolumeAutoGain-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MasterVolumeAutoGain-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MasterVolumeAutoGain-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MasterVolumeAutoGain-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MasterVolumeAutoGain-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/MasterVolumeAutoGain.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MasterVolumeAutoGain.iss",inplace=1):
