...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MasterVolumeAutoGain Demo Installer\n"
      else:
        line="OutputBaseFilename=MasterVolumeAutoGain Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MasterVolumeAutoGain Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MasterVolumeAutoGain installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MasterVolumeAutoGain Demo installer\n"
     else:
       line="SetupWindowTitle=MasterVolumeAutoGain installer\n"
